...
# Copyright (c) 2014 Stas Zytkiewicz stas@childsplay.mobi
#
#           math_test.py
...
# self.logger =  logging.getLogger("schoolsplay.math_test.Activity")
# self.logger.error("I don't understand logger")
# See SP manual for more info 

module_logger = logging.getLogger("schoolsplay.math_test")
...
class Activity:
  ...
  """
    ...
    def __init__(self,SPGoodies):
        ...
        self.my_datadir = os.path.join(self.SPG.get_libdir_path(),'CPData','Math_testData')
        ...
        self.rchash = utils.read_rcfile(os.path.join(self.my_datadir, 'math_test.rc'))
