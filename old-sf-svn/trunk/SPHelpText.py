...
class Global(object):
    no_alphabet_sounds = _(\
"You don't have the alphabet sound package installed for your language or the locale '%s' isn't supported yet. See the www.schoolsplay.org for additional downloads or how to provide support for your language")

    no_sound_availabe = _("You don't have the pygame sound modules installed. This activity needs sound so it can't be used.")
    not_enough_content = _("There's are not enough images and/or sounds available, found only %s items")
