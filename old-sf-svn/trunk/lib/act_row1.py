...
class RowWidget(SimpleGladeApp):
    ...
    def __init__(self, parent=None,numbersrange=20,level=1,\
                glade_path="row1.ui", root="window_row5", domain=None):
    ...
    def _create_exercise(self):
        ...
        if self.level == 1:
            ...
            self.e_list[2].set_text(str(self.numbers[2]))
            self.e_list[2].set_editable(False)# prevent editing
            self.predefined = [self.e_list[0],self.e_list[1], self.e_list[2]]
        if self.level == 2:
            self.e_list[0].set_text(str(self.numbers[0]))
            self.e_list[0].set_editable(False)# prevent editing
            self.e_list[1].set_text(str(self.numbers[1]))
  ...
  """
    ...
    def _next_exercise(self):
        ...
        self.exercisewidget = RowWidget(parent=self,\
                            ...
                            glade_path=os.path.join(self.my_datadir,'row1.ui'))
    ...
    def post_next_level(self):
        """Mandatory method.
        This is called by the core after 'next_level'.
