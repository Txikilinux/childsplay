...
DOCDIR = os.path.join(BASEPATH, 'share', 'doc', 'cognitionplay')
LOCALEDIR = os.path.join(BASEPATH, 'share','locale')
BASEDIR = os.path.join(BASEPATH, 'cognitionplay')
SHARELIBDATADIR = os.path.join(BASEPATH, 'share', 'cognitionplay')
ALPHABETDIR = os.path.join(BASEPATH,'share','sp_alphabetsounds')
PYTHONCPDIR = os.path.join(get_packagesdir(), 'cognitionplay')
