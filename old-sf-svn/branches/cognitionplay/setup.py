...
"""
------------------------------------------------------------------------------
This script will install cognitionplay on your system.
...
This script also generate a module with all the paths needed by cognitionplay.
...
"schoolsplay", you can just read "cognitionplay" instead.
-------------------------------------------------------------------------------
...
if sys.argv[1] == 'uninstall':
    UNINSTALL = True
    print "\n------------ Uninstalling cognitionplay ----------------\n"
    print "I'm going to completely remove cognitionplay from your system."
    ans = raw_input("Hit 'y' to remove cognitionplay > ")
    if ans.lower() != 'y':
        print "Operation canceled, leaving cognitionplay intact."
        sys.exit(0)
else:
    UNINSTALL = False
    print __doc__
...
try:
    ...
    raise SystemExit, "cognitionplay requires distutils (Python-dev) to build and install."
...
dest = os.path.join(PREFIX, 'share', 'cognitionplay')
...
if not UNINSTALL:
    ...
    print "Copy cognitionplay activity data dirs..."
...
if not UNINSTALL:
    ...
    print "Copy cognitionplay English alphabetsounds directory..."
...
if not UNINSTALL:
    print "Install cognitionplay programs..."
...
if UNINSTALL:
    print "cognitionplay IS REMOVED"
    print "Bye..."
    sys.exit(0)
...
DESCRIPTION = """cognitionplay is a collection of educational activities and
...
print "\n====== all done ======"
print "cognitionplay is installed in %s" % starterpath
print "To start cognitionplay just type 'cognitionplay' in a xterm"
print "To see the available commandline options type 'cognitionplay --help in a xterm\n"
