...
class Worker(threading.Thread):
    ...
    def __init__(self,delay=None,func=None,fargs=None,loop=1,lock=None):
    ...
    def __sleep(self,secs):
        """Sleep fuction that checks every second to see if we should die"""
        while secs:
            if not self.__do:
                break
...
class Timer:
    def __init__(self,delay=1,func=None,fargs=(),loop=-1,lock=None):
        ...
        self.worker = Worker(delay,func,fargs,loop,lock)
