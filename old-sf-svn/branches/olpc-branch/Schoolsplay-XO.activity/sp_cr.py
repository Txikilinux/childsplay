...
from SPWidgets import InfoDialog, xpm_label_box
import SPHelpText
...
class MainWindow(SimpleGladeApp):
    def __init__(self, parent=None, dice_cbf=None,\
                glade_path="sp_cr.glade", root="mainwindow", domain=None):
        ...
        self.label26.modify_font(pango.FontDescription(fnt))# Bottombar 'activity:'
        self.label27.modify_font(pango.FontDescription(fnt))# Bottombar 'user:'
        self.label28.modify_font(pango.FontDescription(fnt))# Bottombar 'activity:'
        ...
        self.dicelist.sort()
        # Change the image used for the button
        image = gtk.Image()
...
class QuitDialog(SimpleGladeApp):
    def __init__(self, parent=None, glade_path="sp_cr.glade", root="quit_dialog", domain=None):
...
class LoginDialog(SimpleGladeApp):
    ...
    def __init__(self, parent=None, glade_path="sp_cr.glade", root="login_dialog", domain=None):
    ...
    def on_button_cancel_clicked(self, widget, *args):
        ...
        dlg = QuitDialog()
        if dlg.run() == -5:
            print "RESPONSE_OK from quit dialog"
...
class TopbarContainer(SimpleGladeApp):
    def __init__(self, parent=None, toggle_labels=['10','20','100','1000'],\
                glade_path="sp_cr.glade", root="topbarcontainer", domain=None):
        ...
        align = self.alignment28
        align.add(self.bb)
        # define some members
        self.numbersrange = int(toggle_labels[0])
