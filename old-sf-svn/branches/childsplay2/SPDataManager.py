...
from SPConstants import DBASEPATH, ACTIVITYDATADIR, DBASE, HOMEDIR
...
class DataManager:
    ...
    def __init__(self, spgoodies):
        ...
        DBASEPATH = os.path.join(HOMEDIR, self.cmd_options.theme, DBASE)
    ...
    def get_mapper(self, activity):
        ...
        if self.anonymous or not activity:
            ...
            return BogusMapper()
        try:
            mclass = RowMapper(self.tables[activity], self.current_user_id, self.current_user)
...
class RowMapper:
    ...
    def __init__(self, table, user_id=None, current_user=''):
    ...
    def commit(self):
        ...
        self.logger.debug("table %s commit data to dbase" % self.table)
