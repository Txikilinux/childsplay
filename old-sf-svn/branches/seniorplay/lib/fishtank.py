...
class Activity:
  ...
  """
    ...
    def __init__(self,SPGoodies):
        ...
        self.bubimg = utils.load_image(os.path.join(self.my_datadir,'backgrounds','childsplay','blub0.png'))
    ...
    def score_observer(self, score):
        ...
        if score < 0:
            score = 1
        self.scoredisplay.increase_score(score + self.level*3)
    ...
    def start(self):
        ...
        self.level_data = [(10,-90,8,4,4),(20,0,8,4,4),(20,0,8,4,4),(20,890,4,6,4),\
