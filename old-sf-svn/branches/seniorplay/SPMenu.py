...
class Menu:
    def __init__(self, iconpath, default, menu, cbf, theme, lang):
        ...
        for k, v in buttons.items():
            ...
            b = TransImgButton(p0, p1, k[1], padding=6, name=v)
    ...
    def get_default_buttons(self):
        return self.defaultbuttonslist
...
class Activity:
    ...
    def _build_menu(self, theme_dir, theme_rc, lang):
        ...
        try:
            self.Mn = Menu(p, self.rootmenu[3], self.menu, self.menu_callback, theme_rc, lang)
        except Exception, info:
    ...
    def next_level(self, level):
        ...
        menubuttons = self.Mn.get_default_buttons()
        self.displayed_buttons = menubuttons
        self._display_buttons(menubuttons)        
